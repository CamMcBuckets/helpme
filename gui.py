...
if num1 != "":
    ...
    def calculate():
        # Create a label or figure with the output you want with circle1
        return
...
if num2 != "":
    ...
    def calculate():
        # Create a label or figure with the output you want with circle2
        return
...
if num3 != "":
    ...
    def calculate():
        # Create a label or figure with the output you want with circle3
        return
